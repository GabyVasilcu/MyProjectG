class Graph {
    ...
    determineYPoints(dataSeries) {
        ...
        min = Math.min.apply(this, yPoints);
        max = Math.max.apply(this, yPoints);
        ...
        console.log("this_yPoints", this.yPoints);
        this.ctx.beginPath();
        this.ctx.moveTo(this.xPoints[0], this.yPoints[dataSeries[0].y], 5, 0, 2 * Math.PI)
       // this.ctx.stroke();
        for (var i = 0; i < dataSeries.length; i++) {
        //     this.xPoints.push(x);
        //     x += segmentLength;
         //   this.ctx.beginPath();
            ...
            this.ctx.lineTo(this.xPoints[i], this.yPoints[dataSeries[i].y], 5, 0, 2 * Math.PI);
            this.ctx.stroke();
        }
